...
export default function MapLegend({ mapType }: MapTypeProps) {
  const data = weatherLegends[mapType];

  return <div>MapLegend</div>;
}

const weatherLegends: Record<
  "rain" | "snow" | "clouds" | "temperature" | "pressure" | "wind",
  {
    name: string;
    stops: {
      value: number;
